      ...
      return h('section', { className: 'dpr-section', 'aria-label': '智能路由设置' },
        ...
        h('div', { className: 'dpr-card' },
          ...
          h('details', { className: 'dpr-advanced' },
            ...
            h('p', { className: 'dpr-hint' }, '在聊天模型菜单中统一选择：默认、关闭、低、中、高。默认跟随本地模型的默认档位，未声明时按中档处理；隐私分类始终关闭推理。'),
            h('p', { className: 'dpr-hint' }, 'Qwen / DeepSeek 对应关系：关闭 Off / Off，低 Low / Low，中 Medium / High，高 High / Max。默认通常为 Medium / High；本地默认改为 Low 时，云端也使用 Low。'),
